...
//		String apkPath = appPath + "/" + apk + ".apk";
        ...
        while ((temp = bf.readLine())!= null){
            ...
            System.out.println("Start building CFG for: " + temp);
            String apk = temp;
            String apkPath = appPath + "/" + apk + ".apk";
            try {
                apkg.generateCFG(apk, apkPath);
            }
            catch (Exception e){
                continue;
            }
...
//        String androidPlatformPath = "/Users/majunqi0102/Library/Android/sdk/platforms/android-23/android.jar";
	...
	private void printAugmentedCFG(String app) throws IOException {
