...
public class APKCallGraph {
	...
	static String androidPlatformPath = "./android.jar";
...
//		String appPath = "/Users/shaoyang/Desktop/API_exp/sampletest/apks/";
		...
		String apkPath = "./testapks_m/" + apk + ".apk";
...
//			}
		...
		File file = new File("./dot_output_m/" + apk + "/");
		file.mkdir();
		exporter.exportGraph(jg, new FileWriter("./dot_output_m/" + apk + "/" + apk + ".dot"));
	}
